...
Router::middleware('GET', '/.*', function () {
    header('X-Powered-By: Soanix/router');
});

// Static route: / (homepage)
Router::get('/', function () {
    echo '<h1>Soanix/router</h1>
...
Router::get('/hello', function () {
    echo '<h1>Soanix/router</h1><p>Visit <code>/hello/<em>name</em></code> to get your Hello World mojo on!</p>';
});
